    ...
    while (stop == false)
    {
	   ...
	   //cout<<"Prueba Luis"<<endl;
        ...
        if(key == 'p'){
            ...
            normalize(blue, blue, 0, histBlue.rows, NORM_MINMAX, -1, Mat() );
            normalize(green, green, 0, histGreen.rows, NORM_MINMAX, -1, Mat() );
            normalize(red, red, 0, histRed.rows, NORM_MINMAX, -1, Mat() );
